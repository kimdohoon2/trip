...
export default function ThemeToggle() {
  ...
  return (
    <div className="w-[30px] h-[30px] lg:w-[40px] lg:h-[40px] relative cursor-pointer">
      ...
      >
        <FontAwesomeIcon
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 black text-[16px] lg:text-[20px] text-lightorange"
          icon={faSun}
        />
      </div>
      <div
      ...
      >
        <FontAwesomeIcon
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 black text-[16px] lg:text-[20px] text-white"
          icon={faMoon}
        />
      </div>
    </div>
