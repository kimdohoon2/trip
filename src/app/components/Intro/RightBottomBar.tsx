...
export default function RightBottomBar() {
  ...
  return (
    ...
    >
      ...
      <path ref={pathRefs[2]} d="M250 600H150V325H250V600Z" fill="black" strokeWidth="5" />
      <path ref={pathRefs[3]} d="M250 275H150V-5.96046e-06H250V275Z" fill="black" strokeWidth="5" />
      <path ref={pathRefs[4]} d="M100 600H0V325H100V600Z" fill="black" strokeWidth="5" />
      <path ref={pathRefs[5]} d="M100 275H0V-5.96046e-06H100V275Z" fill="black" strokeWidth="5" />
    </svg>
  );
}
